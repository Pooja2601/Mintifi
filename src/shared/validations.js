...
const validationBusinessDetails = {
  ...
  NO_OF_FOUNDERS: {
    ...
    type: "number",
    pattern: /^[0-9]$/,
    title: "Enter Number of Founding Partner",
    required: false,
  ...
  PINCODE: validationPersonalDetails.PINCODE,
  ADDRESS1: validationPersonalDetails.ADDRESS1,
  ADDRESS2: validationPersonalDetails.ADDRESS2,
  DOB: validationPersonalDetails.DOB,
  OWNERSHIP: validationPersonalDetails.OWNERSHIP
};
