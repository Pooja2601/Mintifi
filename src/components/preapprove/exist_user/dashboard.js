...
class Dashboard extends Component {
  ...
  render() {
    ...
    if (environment === "local") loan_app_payload = existUserPayload;
      ...
      <>
        ...
        {loan_app_payload === Object(loan_app_payload) ? (
          <h5 className="alert-heading text-center">
            ...
            Dear{" "}
            <b>
              <i> {loan_app_payload.user_name}</i>
            </b>
          </h5>
        ) : null}
        <br />
        ...
        {loan_app_payload === Object(loan_app_payload) ? (
          ...
          >
            ...
            <div
              className={
                loan_app_payload.loan_status === "pending"
                  ? "alert alert-info"
                  : "alert alert-success"
              }
            >
        ...
        >
          <div className={"blockquote-footer"}>
            ...
            <b>
              ( loan application id :{" "}
              {loan_app_payload === Object(loan_app_payload)
                ? loan_app_payload.loan_application_id
                : null}
              )
            </b>{" "}
            in the request.
