...
class FetchOffers extends Component {
    ...
    _fetchCreditLimit = () => {
        ...
        return fetch(`${baseUrl}/companies/${payload.company_id}/limit/${reqParam}`, {
            method: 'GET',
    ...
    _fetchLoanStatus = () => {
        ...
        return fetch(`${baseUrl}/loans/${payload.loan_application_id}/status/${reqParam}`, {
            method: 'GET',
            headers: {'Content-Type': 'application/json', token: token}
    ...
    _fetchLoanOffers = () => {
        ...
        return fetch(`${baseUrl}/loans/${payload.loan_application_id}/offers/${reqParam}`, {
            method: 'GET',
            headers: {'Content-Type': 'application/json', token: token},
