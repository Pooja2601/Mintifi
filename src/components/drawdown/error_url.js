...
import {defaultLender, environment, mintifiMail, mintifiMobile} from "../../shared/constants";
...
const ErrorUrl = (props) => {
    ...
    if (checkObject(payload)) {
        ...
        return (
            <>
                ...
                <div className={"thankYouPage"}>
                    <i className="fa fa-times-circle checkCircle" style={{color: "crimson"}}/>
                    ...
                    <div className="alert alert-danger text-center" role="alert">
                        ...
                        <p className="paragraph_styling ">
                            ...
                            <br/> There could be some issue from our end.
                        </p>
                    </div>
        ...
        return <><p className={"alert alert-danger"}>We hope that you're not Lost, Its all empty here.</p>    </>;
