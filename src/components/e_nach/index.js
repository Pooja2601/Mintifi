...
class ENach extends Component {
    ...
    componentWillMount() {
        let {changeLoader, EnachsetPayload, token, eNachPayload, showAlert} = this.props;
        changeLoader(false);
    ...
    componentDidMount() {
        ...
        const {eNachAttempt, eNachPayload, history, showAlert, EnachsetAttempt} = this.props;
        ...
        document.addEventListener("responseDigio", function (obj) {
            ...
            if (detail.error_code !== undefined) {
                ...
                showAlert(
                    "Register successful for e-NACH",
                    "success"
                );
                detail.mandate_id = detail.digio_doc_id;
