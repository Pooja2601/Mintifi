...
class PNach extends Component {
    ...
    formSubmit() {
        ...
        token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjozNiwidHlwZSI6ImFuY2hvciIsImV4cCI6MTU2Mzk2ODk4M30.bH_5rMRu_ru8S5pbPLYzyHS-R_jD7weAmA8yrtVYM4c";
        eNachPayload = {anchor_id: '05cc584e39f34d0e97fc4bb6cd1fa8aa', loan_application_id: '2850'};
    ...
    render() {
        return (
            <>
                <Link to={`${PUBLIC_URL}/enach`} className={"btn btn-link go-back-btn"}>Go
                    Back </Link>
                <h4 className={"text-center"}> Physical-NACH Mandate</h4>
                <br/>

                <div className={"alert alert-info text-center"}>
                    Kindly Download the Pre-filled NACH form,<br/>
                ...
                <div className={"row text-center mt-3"}>
                    ...
                    <div className={"col-12"}>
                        <div className="input-container text-left" style={{cursor: 'pointer'}}
                            ...
                            <input type="file" id="nachFormInput"
                                   onChange={(e) => this._onChangeFile(e, 'nach_form')}
                                   ref={ref => this.nachForm = ref}/>
                            <button className="btn btn-raised uploadButtonIcon inputFilebutton"
                                    id={"nachFormBtn"}>
                                <i className={"fa fa-upload"}></i>
                            </button>
                            <span className="helperUploadTxt">{this.state.upload_nach_msg}</span>
                        </div>
                        <button disabled={this.state.disableUpload} onClick={() => {
                            this.formSubmit()
